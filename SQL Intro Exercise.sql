...
-- find all products that cost $11.99 or $13.99
 SELECT * FROM bestbuy.products WHERE products.Price = 11.99 OR cost = 13.99;
...
-- find all employees who don't have a middle initial
 SELECT * FROM bestbuy.employees WHERE employees.MiddleInitial = '';
...
-- find all Geek Squad employees who don't have a middle initial 
 SELECT * FROM bestbuy.employees WHERE employees.MiddleInitial = '' AND employees.Title = 'Geek Squad';
